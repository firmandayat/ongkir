@extends('layouts.ongkir')

@section('content')
    <div class="container">
        <div>
            <h1 class="d-flex justify-content-center">Cek Ongkir</h1>
            <p class="lead d-flex justify-content-center mb-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quae, ipsum.</p>
        </div>
